...
impl PairRequestAiding {
        ...
        I: Iterator<Item = &'a str>,
    {
        ...
        let gnss_system_i8: i8 = gnss_system_str
            .parse()
            .map_err(|_| ParseError::ParsingError("invalid gnss_system"))?;
        let gnss_system = match gnss_system_i8 {
            -1 => GnssSystem::NotApplicable,
            0 => GnssSystem::Gps,
        ...
        let time_of_week = match it.next() {
            Some(field) => field
                .parse()
    ...
    pub fn to_fields(&self) -> String {
        match self.gnss_system {
            GnssSystem::NotApplicable => format!(
                "PAIR010,{},{}",
                self.aiding_type.clone() as u8,
                self.gnss_system.as_i8(),
            ),
            _ => format!(
                "PAIR010,{},{},{},{}",
                self.aiding_type.clone() as u8,
